...
const api = axios.create({
  baseURL: import.meta.env.VITE_API_URL || 'https://kanvariya-backend-hte2ghd3cgfbazch.southeastasia-01.azurewebsites.net/api',
...
const FUNCTION_API_URL = 'https://kanvariya-filter-app-gzabhvadeqacf4du.southeastasia-01.azurewebsites.net/api';
